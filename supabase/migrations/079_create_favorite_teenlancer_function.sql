-- Create a simple function to favorite a teenlancer
-- This function will automatically create the poster's profile if it doesn't exist
-- This simplifies favoriting and avoids foreign key constraint errors
